      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        <Section icon={Database} title="8. Cookies & Tracking">
          ...
          <ul className="list-disc ml-5 space-y-1.5 mt-2">
            <li><strong>Meta pixel</strong> — only on <code>/join</code>, <code>/start</code> and <code>/register</code>: our two ad landing pages and the signup form they lead to. It sets an <code>_fbp</code> cookie and tells us whether people who clicked an ad actually arrived and finished signing up. It is the only way to know if we are wasting money on ads. It does not run anywhere else on the site, and never once you are signed in — creating your account is the last page it sees.</li>
