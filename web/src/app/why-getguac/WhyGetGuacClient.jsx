...
export default function WhyGetGuacClient() {
        ...
        <div style={{ maxWidth: 1140, margin: '0 auto' }}>
          ...
          <div className="gj-herorow">
            ...
            <div className="gj-heroleft">
              ...
              {/* THE HERO ASK WAS REMOVED HERE.
                  On /join this slot held the signup stack — Try 1 receipt,
                  Start free with Google, See how it works, Try the demo, the
                  "Free forever / No card required / One tap" trust row, both
                  store badges, "or sign up with email" and the sign-in line.
                  This page argues why GetGuac is a different KIND of product;
                  it is not an ad destination, so it does not ask for the
                  account in the first screen. The closing CTA at the bottom of
                  the page is the ask. heroCtaRef is intentionally left
                  unattached — the effect that observes it null-guards. */}
            </div>
...
const MATRIX_APPS = ['GetGuac', 'Credit Karma', 'YNAB', 'Rocket Money', 'Monarch', 'Copilot']
const MATRIX = [
