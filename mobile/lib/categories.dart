...
const List<Category> kPresetCategories = [
  ...
  Category(slug: 'bills',         label: 'Bills',         emoji: '💡', desc: 'Utilities — mobile, phone, internet, electricity, gas, water, trash, insurance', color: 'sky', healthTier: 'neutral'),
  Category(slug: 'bank-fees',     label: 'Bank Fees',     emoji: '💸', desc: 'Interest, finance charges, fees',           color: 'red',     healthTier: 'neutral'),
  Category(slug: 'cloud',         label: 'Cloud',         emoji: '☁️', desc: 'Hosting, domains, SSL/CDN, cloud infra',     color: 'sky',     healthTier: 'neutral'),
  ...
  Category(slug: 'pharmacy',      label: 'Pharmacy',      emoji: '💊', desc: 'Rx, OTC meds, first aid',                   color: 'rose',    healthTier: 'healthy'),
  Category(slug: 'health',        label: 'Health',        emoji: '🥗', desc: 'Vitamins, supplements, protein',            color: 'emerald', healthTier: 'healthy'),
  Category(slug: 'personal-care', label: 'Personal Care', emoji: '🪥', desc: 'Toothpaste, soap, shampoo, deodorant',      color: 'pink',    healthTier: 'neutral'),
  Category(slug: 'household',     label: 'Household',     emoji: '🧻', desc: 'Bath tissue, paper towels, cleaning',       color: 'amber',   healthTier: 'neutral'),
  Category(slug: 'gas-up',        label: 'Gas Up',        emoji: '⛽', desc: 'Fuel only — gasoline, diesel, EV charging', color: 'red',     healthTier: 'neutral'),
  Category(slug: 'auto',          label: 'Auto',          emoji: '🚗', desc: 'Car maintenance, parts, tires, repair, wash, tolls, registration', color: 'slate', healthTier: 'neutral'),
