...
// directly from getguac.app/download without depending on a GitHub Release
// existing. The mobile UpdateService still polls GitHub for in-app update
...
export default function DownloadClient() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
      ...
      <section className={`bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm mb-6 ${platform === 'android' ? 'ring-2 ring-emerald-300' : ''}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-xl font-extrabold text-emerald-900 flex items-center gap-2 flex-wrap">
              ...
              {platform === 'android' && (
                <span className="text-[11px] font-semibold uppercase tracking-wider bg-lime-200 text-emerald-900 rounded-full px-2 py-0.5">You&apos;re on Android</span>
              )}
            </h2>
      ...
      {/* iOS */}
      <section className={`bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm mb-6 ${platform === 'ios' ? 'ring-2 ring-emerald-300' : ''}`}>
        <div className="flex items-start gap-4">
      ...
      {/* Web */}
      <section className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm mb-6">
        <div className="flex items-start gap-4">
      ...
      <p className="text-center text-xs text-gray-500 mt-8">
        Source &amp; full release notes: <a href="https://github.com/ramsrivatsasa/getguac/releases" className="underline text-emerald-700 hover:text-emerald-900">GitHub</a>
      </p>
