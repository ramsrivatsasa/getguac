...
const ANDROID_RELEASE = {
  ...
  base: 'https://github.com/ramsrivatsasa/getguac/releases/download/v0.2.63',
  apks: [
    ...
    { abi: 'x86_64',      sizeMB: 22.5, label: 'Android emulators + Chromebooks',                                file: 'app-x86_64-release.apk',      primary: false },
  ],
}
