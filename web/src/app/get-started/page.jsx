...
const steps = [
  ...
  { n:'20', chapter:'rhythm', icon:Inbox, title:'Let Smashlist prepare the next trip', body:'Review predicted or remembered items, keep only what you need, group the list by store, and share it when someone else is shopping with you.', why:'A prepared list reduces repeat decisions and makes the next shopping trip easier to finish.', action:['/goals/prepare.html','See how Smashlist prepares'], shot:['/home/goals/web-smashlist.webp','A GetGuac Smashlist organized for the next shopping trip'] },
