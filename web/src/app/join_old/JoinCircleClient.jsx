'use client'
// ⚠️ DEMO FORK OF JoinClient.jsx — NOT A ROUTE. Rendered only by
// app/preview/join-circle/page.jsx so the receipt circle can be judged inside
// the real, whole /join page instead of on a stripped-down mockup.
//
// It is a byte-for-byte copy of JoinClient.jsx with exactly TWO changes:
//   1. the component is renamed JoinCircleClient
//   2. <CardRail n={0} /> ("How can Guac-AI help today?" — the three big cards)
//      is replaced by <ReceiptCircle />
//
// 🔴 This file WILL drift from JoinClient.jsx the moment anyone edits the real
// one. It is a throwaway for a design decision: once the circle is accepted,
// make change (2) in JoinClient.jsx and DELETE this file. Do not fix bugs here.
//
  ...
  return (
    ...
    <div style={{ background: '#fff', overflowX: 'hidden' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(20,83,45,0.10)', marginTop: 40, paddingTop: 8, background: 'linear-gradient(180deg,#FCFDFA 0%,#FFFFFF 220px)' }}>
        ...
        {/* THE ONE SWAP. Was <CardRail n={0} /> — the "How can Guac-AI help
            today?" rail of three big cards (Find Money You're Missing / See
            Where Your Money Goes / Every Receipt, Organized). Those three cards
            now appear nowhere on this page: rails 1-5 slice CARDS from index 3
            up, so nothing shifted into the gap. */}
        <ReceiptCircle />
        <CardRail n={1} />
