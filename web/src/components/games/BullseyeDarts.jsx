  ...
  return (
    <div className="w-full select-none">
      <div
        ...
        style={{ height: 'clamp(430px, calc(100svh - 240px), 720px)', minHeight: 430, background: '#191512', borderTop: '1px solid rgba(87,83,78,0.5)', borderBottom: '1px solid rgba(87,83,78,0.5)' }}
      >
        <canvas
          ref={canvasRef}
