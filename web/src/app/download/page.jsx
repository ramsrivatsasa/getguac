...
const ANDROID_RELEASE = {
  ...
  base: 'https://github.com/ramsrivatsasa/getguac/releases/download/v0.1.7',
  apks: [
    { abi: 'arm64-v8a',   sizeMB: 19.2, label: 'Most modern Android phones (Samsung, Pixel, OnePlus, etc.)', file: 'app-arm64-v8a-release.apk',   primary: true  },
    { abi: 'armeabi-v7a', sizeMB: 16.8, label: 'Older 32-bit Android phones',                                   file: 'app-armeabi-v7a-release.apk', primary: false },
    { abi: 'x86_64',      sizeMB: 20.6, label: 'Android emulators + Chromebooks',                                file: 'app-x86_64-release.apk',      primary: false },
  ],
}
