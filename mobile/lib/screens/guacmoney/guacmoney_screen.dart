      ...
      body: FutureBuilder<_Gm>(
        ...
        builder: (ctx, snap) {
          ...
          return ListView(padding: const EdgeInsets.all(16), children: [
              ...
              child: Column(children: [
                ...
                TweenAnimationBuilder<int>(
                  ...
                  builder: (_, v, __) => Text(formatGm(v),
                    style: TextStyle(fontSize: 42, fontWeight: FontWeight.w900, color: Colors.white, height: 1, fontVariations: ggWght(FontWeight.w900))),
                ),
                Text('GUACMONEY', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: 2, fontVariations: ggWght(FontWeight.w800))),
                const SizedBox(height: 6),
                Text(kGmTagline, textAlign: TextAlign.center, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white, fontVariations: ggWght(FontWeight.w700))),
            ...
            // Highlighted savings — the real value our Guac-AI delivered.
            if (saved > 0) ...[
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF34d399), Color(0xFF15803d)]),
                  borderRadius: BorderRadius.circular(16),
                  boxShadow: [BoxShadow(color: const Color(0xFF15803d).withValues(alpha: 0.25), blurRadius: 12, offset: const Offset(0, 4))],
                ),
                child: Row(children: [
                  Container(
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text('our Guac-AI saved you', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 12, fontVariations: ggWght(FontWeight.w700))),
                  ])),
                ]),
              ),
              const SizedBox(height: 16),
            ...
            const SizedBox(height: 16),
            _card(Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Where it came from', style: TextStyle(fontWeight: FontWeight.w800, fontVariations: ggWght(FontWeight.w800))),
              const SizedBox(height: 6),
            ...
            Row(children: [
              Expanded(child: FilledButton.icon(
                ...
                label: Text('Rate buys', style: TextStyle(fontWeight: FontWeight.w800, fontVariations: ggWght(FontWeight.w800))),
              )),
              ...
              Expanded(child: OutlinedButton.icon(
                ...
                label: Text('Refer +1,000', style: TextStyle(fontWeight: FontWeight.w800, fontVariations: ggWght(FontWeight.w800))),
              )),
            ]),
            const SizedBox(height: 16),
          ]);
  ...
  Widget _row(IconData icon, String label, String sub, int gm, Color color) => Padding(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(label, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, fontVariations: ggWght(FontWeight.w700))),
            Text(sub, style: const TextStyle(fontSize: 11, color: Colors.black45)),
          ])),
          Text('+${formatGm(gm)}', style: TextStyle(fontWeight: FontWeight.w900, color: color, fontVariations: ggWght(FontWeight.w900))),
        ]),
      );
}
