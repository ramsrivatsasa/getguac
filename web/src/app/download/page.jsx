...
const ANDROID_RELEASE = {
  ...
  base: '/downloads/v0.3.36',
  apks: [
    { abi: 'arm64-v8a',   sizeMB: 21.9, label: 'Most modern Android phones (Samsung, Pixel, OnePlus, etc.)', file: 'app-arm64-v8a-release.apk',   primary: true  },
