...
const ANDROID_RELEASE = {
  ...
  base: '/downloads/v0.3.40',
  apks: [
    { abi: 'arm64-v8a',   sizeMB: 22.1, label: 'Most modern Android phones (Samsung, Pixel, OnePlus, etc.)', file: 'app-arm64-v8a-release.apk',   primary: true  },
