...
export const CATEGORIES = [
  ...
  { slug: 'bills',         label: 'Bills',         emoji: '💡', desc: 'Utilities — mobile, phone, internet, electricity, gas, water, trash, insurance', color: 'sky', health_tier: 'neutral' },
  ...
  { slug: 'cloud',         label: 'Cloud',         emoji: '☁️', desc: 'Web hosting, domains, SSL/CDN, cloud infra (AWS/GCP/Azure), VPS, email hosting', color: 'sky', health_tier: 'neutral' },
  ...
  { slug: 'gas-up',        label: 'Gas Up',        emoji: '⛽', desc: 'Fuel only — gasoline, diesel, EV charging', color: 'red',     health_tier: 'neutral' },
  { slug: 'auto',          label: 'Auto',          emoji: '🚗', desc: 'Car maintenance, parts, tires, repair, wash, tolls, registration', color: 'slate', health_tier: 'neutral' },
...
export const SUB_TAGS_BY_CATEGORY = {
  ...
  bills: [
    ...
    { slug: 'landline',    emoji: '☎️', label: 'Landline' },
  ...
  cloud: [
    { slug: 'domain',      emoji: '🌐', label: 'Domain' },
    { slug: 'web-hosting', emoji: '🖥️', label: 'Web hosting' },
    { slug: 'vps',         emoji: '🛢️', label: 'VPS' },
    { slug: 'cloud-infra', emoji: '☁️', label: 'Cloud infra' },
    { slug: 'cdn-ssl',     emoji: '🛡️', label: 'CDN / SSL' },
    { slug: 'email-host',  emoji: '📨', label: 'Email host' },
  ],
  subs: [
