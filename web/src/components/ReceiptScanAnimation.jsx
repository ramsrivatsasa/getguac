      ...
      <div className="relative flex flex-col items-center pointer-events-auto">
        ...
        <div className="mt-5 pl-2 pr-4 py-1 rounded-full bg-white/95 shadow-md border border-emerald-100 flex items-center gap-2">
          {/* maracas avocado shaking next to the status text (finalized variant),
              mirrored horizontally via inline style so it works regardless of
              Tailwind scale-utility config. */}
          <span className="inline-block" style={{ transform: 'scaleX(-1)' }}><GuacMascotAnimated animation="maracas" size={42} /></span>
