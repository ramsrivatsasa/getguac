...
const ANDROID_RELEASE = {
  ...
  base: '/downloads/v0.3.12',
  apks: [
    { abi: 'arm64-v8a',   sizeMB: 21.6, label: 'Most modern Android phones (Samsung, Pixel, OnePlus, etc.)', file: 'app-arm64-v8a-release.apk',   primary: true  },
    { abi: 'armeabi-v7a', sizeMB: 19.4, label: 'Older 32-bit Android phones',                                   file: 'app-armeabi-v7a-release.apk', primary: false },
