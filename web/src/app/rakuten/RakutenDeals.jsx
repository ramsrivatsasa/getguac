'use client'
// Client half of /rakuten — fetches GET /api/rakuten/coupons (server-side
// proxy that holds the OAuth2 credentials) and renders the coupon grid.
// Until the RAKUTEN_* env vars are set, that route returns 503
// {configured:false} and this shows a friendly "coming soon" state instead
// of an error. Chrome (nav/footer) comes from MarketingShell in page.jsx.
...
export default function RakutenDeals() {
