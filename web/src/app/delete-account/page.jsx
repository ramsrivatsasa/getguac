'use client'
// Public account-deletion page — required by Google Play's data-deletion
// policy. The URL (getguac.app/delete-account) goes in the Play Console Data
// safety form. It must: name the app, show the deletion steps, and list what
// data is deleted/kept + retention. Signed-in users can also delete right here.
...
export default function DeleteAccountPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-lime-50 text-gray-800">
      <div className="max-w-2xl mx-auto px-5 py-12">
        <Link href="/" className="inline-flex items-center gap-2 mb-8">
          <span className="text-2xl">🥑</span>
          <span className="font-black text-emerald-900 text-lg">GetGuac</span>
        </Link>
