...
const ANDROID_RELEASE = {
  ...
  base: '/downloads/v0.3.35',
  apks: [
    { abi: 'arm64-v8a',   sizeMB: 23.1, label: 'Most modern Android phones (Samsung, Pixel, OnePlus, etc.)', file: 'app-arm64-v8a-release.apk',   primary: true  },
