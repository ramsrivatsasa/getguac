...
export const metadata = {
  ...
  description:
    'Play Penalty Shootout free in your browser: lock the sweeping crosshair, stop the power bar and beat the diving keeper. Ten penalties, streak bonuses, no download.',
  ...
  return (
    <GamePageShell
      ...
      how={[
        ...
        'You take ten penalties. A goal is 100 points plus a corner bonus for placement near the posts and bar — and consecutive goals build a streak bonus worth 25 more each.',
      ]}
      tips={[
        ...
        'Protect a streak: a safe 75-power shot into a corner beats a max-power gamble that ends the run at zero.',
      ]}
    >
      <PenaltyShootout />
    </GamePageShell>
